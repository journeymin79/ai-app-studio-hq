...
(H=>{
const navSpec=()=>[
 {title:'Company',items:[['company','🏠','Overview'],['organization','🏛️','Organization'],['current','⚡','Current Work'],['commands','⭐','CEO Commands']]},
